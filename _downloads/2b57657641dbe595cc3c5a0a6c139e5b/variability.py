...
Understanding the light curve estimator, please refer to the :doc:`/tutorials/analysis-time/light_curve`.
For more in-depth explanation on the creation of smaller observations for exploring time variability, refer to :doc:`/tutorials/analysis-time/light_curve_flare`
...
To learn how to compute such an object, see the :doc:`/tutorials/analysis-time/light_curve_flare`
...
######################################################################
# Finally, the variability amplitude ([reference paper](https://ui.adsabs.harvard.edu/abs/1996A%26A...305...42H/abstract)):
